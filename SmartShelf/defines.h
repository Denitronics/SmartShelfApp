...
#define SHELF_UNKNOWN_ICON QLatin1String("icons/573004-200.png")


#define SHELF_DRINK_ITEM_ICON QLatin1String("icons/metal_can.png")
#define SHELF_CHIPS_ITEM_ICON QLatin1String("icons/chips.png")
