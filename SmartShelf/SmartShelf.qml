...
Item {
    ...
    StackLayout {
        id: smartShelfStackLayout

        anchors.fill: parent
        currentIndex: bleController.shelfScreenActiveLayout

        Item {

            id: searchDeviceScreen
            Layout.fillWidth: true
            Layout.fillHeight: true
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    RoundButton {
                        ...
                        text: {
                            if (bleController.searchingInProcess === false)
                            {
                                "Search"
                            }
                            else
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Rectangle {
                   ...
                   id: connectedDeviceScreen
                    Layout.preferredWidth: parent.width - 20
                    Layout.preferredHeight: parent.height / 8 * 7
                ...
                Item {
                    ...
                    RoundButton {
                        width: windowSearchBLE.width / 3
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: "Disconnect"

                        onPressed: {
                            deviceSelected = false
                            bleController.disconnectFromBLEDevice()
                        }
                    }
                }
            }
